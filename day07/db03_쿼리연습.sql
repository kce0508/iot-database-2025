...
/* 문제2 - Employees 에서 모든 사원의 last_name과 연봉을 '이름: 1 Year Salary = $연봉'형식으로 출력하고, 1 Year Salary라는 별칭으로 붙이세요.(107해)
*/
...
/* 문제1 - 사원의 last_name 중 e나 o 글자를 포함한 사원을 출력하시오. 이때 컬럼명은 e And o Name이라고 출력하시오.(10행)
*/
...
-- 단일행 함수 및 변환 함수
/* 문제 1 - 이름이 s로 시작하는 각 사원의 업무를 아래의 예와 같이 출력하고자 함.(18행)
